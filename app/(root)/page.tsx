...
export const metadata: Metadata = {
  title: ` ${pagesConfig.home.metadata.title} | Gentuar Lushtaku`,
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center mt-10">
          <Image
            ...
            alt="Gentuar Lushtaku - Full Stack Developer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                ...
                aria-label="View Gentuar Lushtaku's GitHub profile"
              >
